...
use uv_configuration::{DevGroupsSpecification, NoBinary, NoBuild};
...
pub struct RequirementsSpecification {
    ...
    pub groups: BTreeMap<PathBuf, DevGroupsSpecification>,
    ...
    pub async fn from_sources(
        ...
        if !groups.is_empty() {
            ...
            for (path, groups) in groups_by_path {
                ...
                let group_spec = DevGroupsSpecification::from_args(
                    false,
                    false,
                    false,
                    group,
